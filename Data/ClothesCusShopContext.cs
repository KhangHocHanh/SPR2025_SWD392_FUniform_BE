...
public partial class ClothesCusShopContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=NGUYEN_KHANG\\NGUYENKHANG;Initial Catalog=ClothesCusShop;Integrated Security=True;Trust Server Certificate=True");
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
